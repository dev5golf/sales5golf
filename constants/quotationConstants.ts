...
export const DESTINATION_OPTIONS = ['공항 > 숙소', '숙소 <> 골프장', '공항 > 골프장 > 숙소', '숙소 > 골프장 > 공항', '숙소 > 공항', '일일렌탈 10시간', '일일렌탈 12시간', '편도이동'] as const;
...
export const QUOTATION_NOTES = [
    '견적서는 예약 확정이 아닙니다. 요금 및 일정은 현지 사정 따라 일부 변경될 수 있습니다.',
    ...
    '차량 이용 금액은 탑승/하차 장소에 따라 추가금 발생할 수 있습니다.'
] as const; 