...
const firebaseConfig = {
    ...
    authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "sales5golf.firebaseapp.com",
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "sales5golf",
    storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "sales5golf.appspot.com",
